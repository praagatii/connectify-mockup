      ...
      <div className="px-6 py-16 py-20">
        <div className="mx-auto w-full max-w-4xl space-y-16">
          ...
          <div className="border-t border-black/10 pt-10">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-l from-brand to-brand-deep px-8 py-3.5 font-inter text-sm font-semibold text-white transition-opacity hover:opacity-90"
            >
