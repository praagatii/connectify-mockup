      ...
      <div className="px-6 py-16">
        <div className="mx-auto w-full max-w-6xl space-y-6">
          ...
          <section className="rounded-2xl border border-black/10 bg-surface p-8 sm:p-10">
            ...
            <Link
              href="/contact"
              className="group mt-8 inline-flex items-center gap-2 rounded-full bg-gradient-to-l from-brand/60 to-brand-deep/60 backdrop-blur-md px-8 py-4 font-inter text-sm font-semibold text-white transition-opacity hover:opacity-90"
            >
              Talk to an engineer
              <svg
