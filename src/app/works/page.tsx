...
export const metadata = {
  title: "Works — Connectify",
  description:
    "Platforms we've engineered and taken to market across fintech, healthtech, govtech, mobility, enterprise and more.",
};
  ...
  return (
    <>
      <PageIntro
        ...
        description="Platforms we've engineered and taken to market across fintech, healthtech, govtech, mobility, enterprise and more."
      />
        ...
        <div className="mx-auto w-full max-w-[1440px]">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {industries.map((industry) => {
              const href = `/works?category=${encodeURIComponent(industry.name)}`;
          ...
          {filtered.length === 0 ? (
            <p className="mt-12 text-sm text-muted">
              ...
              <Link href="/works" className="text-black underline underline-offset-4">
                View all projects
              </Link>
              .
            </p>
