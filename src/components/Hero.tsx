  ...
  return (
    <section className="relative min-h-svh">
      <ScrollExpand
        ...
        overlayScrim={0.25}
      >
        <div className="flex h-full w-full flex-col items-center justify-center px-6 text-center lg:px-12">
          ...
          <p className="mt-1 max-w-xl font-inter text-base leading-relaxed text-gray-700">
            End-to-end solutions to build, scale, and strengthen your digital business.
          </p>
          <div className="mt-3 grid w-full grid-cols-3 gap-2 sm:grid-cols-6 lg:gap-3">
            {[
