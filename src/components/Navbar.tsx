        ...
        <div className="mx-auto flex max-w-7xl items-center justify-center px-6 lg:px-12">
          <Popover open={isOpen} onOpenChange={setIsOpen}>
            <PopoverAnchor asChild>
              <div className="flex h-16 w-full items-center justify-between gap-2 rounded-full border border-black/10 bg-white/90 backdrop-blur-md pr-4 shadow-lg md:w-5xl lg:w-4xl">
