        ...
        <div className="grid gap-10 items-start grid-cols-1 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-7">
            <h2
              ...
              className="mb-8 font-inter text-5xl font-extrabold leading-[0.95] tracking-tight text-black lg:sticky lg:top-0 lg:z-10 sm:text-[80px] sm:leading-[0.92] lg:text-[88px]"
            >
